...
SET CONTACTLASTNAME = LEFT(LEFT(contactfullname, POSITION('-' IN contactfullname)-1);
UPDATE SALES_DATASET_RFM_PRJ
SET CONTACTFIRSTNAME = RIGHT(contactfullname, LENGTH(contactfullname) - LENGTH(LEFT(contactfullname, POSITION('-' IN contactfullname))));
-- câu 4
